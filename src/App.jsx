      ...
      {tabs.map(t => {
        ...
        return (
          <button key={t.id} onClick={() => set(t.id)} style={{
            ...
            flexDirection: "column", alignItems: "center", gap: 3, padding: "4px 1px",
          ...
          <div className="aac-header-in">
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div style={{
                ...
                <span style={{ fontFamily: "'Bebas Neue',sans-serif", color: "#fff",
                  fontSize: 13, letterSpacing: 1, display: "inline-block",
                  transform: "skewX(-8deg)" }}>AAC</span>
              </div>
              <span style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 17,
                letterSpacing: .8, color: c.text, lineHeight: 1 }}>
                ALL ABOUT CONSISTENCY
              </span>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
              <Flame size={16} color={c.red} fill={p.streak > 0 ? c.red : "transparent"} />
              <span style={{ fontFamily: "'JetBrains Mono'", fontSize: 13, fontWeight: 700,
                color: p.streak > 0 ? c.text : c.muted }}>{p.streak}</span>
            </div>
          </div>
        </div>
      )}

      <div className={stage === "app" ? "aac-scroll" : "aac-scroll no-header"}>
        {!loaded ? (
